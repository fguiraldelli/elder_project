...
count_enterprise, list_of_enterprises = \
input_output.read_files_from_input(list_of_files,  list_of_enterprises)
#Display the data summary and other values related
